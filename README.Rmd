...
The goal of regexcite is to improve interactions with regexs. 
We provide convenience functions to make some common tasks with string manipulation easier.
